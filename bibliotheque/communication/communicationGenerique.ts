...
*/
export type FormatMessageErreur = FormatMessage<CanalGenerique.ERREUR, FormatErreur>;
 ...
 * - date : la date lors de l'émission.
*/
export type FormatMessageAvertissement = FormatMessage<CanalGenerique.AVERTISSEMENT, FormatAvertissement>;

export function erreur(ID_msg : Identifiant<'message'>, description : string) : FormatMessageErreur {
    return {
        ID: ID_msg,
        type: CanalGenerique.ERREUR,
        corps: {
            erreur : description
        },
...
export function avertissement(ID_msg : Identifiant<'message'>, description : string) : FormatMessageAvertissement {
    return {
        ID: ID_msg,
        type: CanalGenerique.AVERTISSEMENT,
        corps: {
